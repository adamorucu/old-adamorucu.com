...
# Conclusion
We saw how t-SNE works through code. If you'd like to download the post as a notebook you can get it here. We also saw that t-SNE is used for different purposes than PCA, although they both reduce the dimensionality of the data, they do it in a very different way. For this reason the drawbacks that we saw should be carefully considered before being using t-SNE.
